...
В Таблице~\ref{tab:hp_full} приведён полный список гиперпараметров обучения, сгруппированных по функциональному назначению: основные параметры, настройки оптимизатора, весовые коэффициенты функции потерь, параметры аугментации и параметры детекции. Таблица занимает несколько страниц.

\begin{longtable}{p{3.8cm} p{2.6cm} p{7cm}}
\caption{Полный список гиперпараметров обучения модели YOLOv8n. Значения соответствуют конфигурации, использованной в данной работе.}
\label{tab:hp_full} \\
\toprule
\textbf{Параметр} & \textbf{Значение} & \textbf{Описание} \\
\midrule
\endfirsthead
\multicolumn{3}{l}{\textit{Продолжение Таблицы~\ref{tab:hp_full}}} \\
\toprule
\textbf{Параметр} & \textbf{Значение} & \textbf{Описание} \\
\midrule
\endhead
